            ...
            {allClass.map((entry)=> (
                 ...
                 <div className={styles.UserChild_Container}>
                     ...
                     <div className={styles.UserChild_Info}>
                         <div className={styles.UserChild_Information}>Teacher: {entry.admin_username}</div>
                         <div className={styles.UserChild_Information}>Student: {entry.student_last_name}{entry.student_first_name}</div>
                         <div className={styles.UserChild_Information}>Year: {entry.school_year}</div>
                         <div className={styles.UserChild_Information}>Class: {entry.grade}{entry.class_name}</div>
                         <div className={styles.UserChild_Information}>Parent: {entry.parent_username}</div>
                     </div>
                 </div>
             </div>
